...
// Legends
$GLOBALS['TL_LANG']['tl_module']['partnerFrontendForm'] = 'Partner Frontend Eingabe Formulare Customcatalog';
$GLOBALS['TL_LANG']['tl_module']['partnerBenefitForm'] = 'Partner Member Benefit Formular';
$GLOBALS['TL_LANG']['tl_module']['customcatalogreaderpartnerpreview'] = 'Custom Catalog Vorschau';
