...
(
    ...
    (
        ...
        //'email_replyTo'        => array(),
        'email_subject' => array('partner_name'),
        'email_text'    => array('partner_name', 'partner_id', 'customer_gender', 'customer_firstname', 'customer_lastname', 'customer_phone', 'customer_email'),
        'email_html'    => array('partner_name', 'partner_id', 'customer_gender', 'customer_firstname', 'customer_lastname', 'customer_phone', 'customer_email'),
    )
);